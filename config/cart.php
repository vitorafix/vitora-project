...
return [
    ...
    'keep_cart_on_clear' => env('CART_KEEP_ON_CLEAR', false), // آیا سبد خرید پس از پاکسازی آیتم‌ها حفظ شود؟
    'max_bulk_operations' => env('CART_MAX_BULK_OPERATIONS', 100), // حداکثر تعداد آیتم در یک عملیات گروهی
    'session_key' => env('CART_SESSION_KEY', 'cart'), // اضافه شده: کلید سشن برای ذخیره سبد خرید
];
