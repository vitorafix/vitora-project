...
<?php $__env->startSection('content'); ?>
    <div class="container mx-auto p-4 sm:p-6 lg:p-8">
        <div class="max-w-4xl mx-auto bg-white p-6 sm:p-8 rounded-xl shadow-lg border border-gray-200">
            ...
            <div class="flex flex-col items-center justify-center mb-8 pb-8 border-b border-gray-200">
                ...
                <h3 class="text-2xl font-bold text-gray-800 mb-1"><?php echo e($user->full_name ?? 'علی احمدی'); ?></h3>
                
                <p class="text-gray-600 mb-2"><?php echo e($user->mobile_number ?? '09123456789'); ?></p>
                
                <span class="bg-green-100 text-green-800 text-sm font-medium px-3 py-1 rounded-full">مشتری عادی</span>
            </div>

            
            <form id="mainProfileForm" action="<?php echo e(route('profile.update')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="bg-gray-50 p-6 rounded-xl shadow-sm border border-gray-100">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="text" id="first_name" name="first_name" class="w-full px-4 py-3 border border-gray-300 rounded-lg text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-green-600 focus:border-green-600 transition-colors duration-200" value="<?php echo e(explode(' ', $user->full_name ?? 'علی احمدی')[0] ?? 'علی'); ?>">
                            </div>
                            <div>
                                <label for="last_name" class="block text-sm font-medium text-gray-700 mb-1">نام خانوادگی:</label>
                                <input type="text" id="last_name" name="last_name" class="w-full px-4 py-3 border border-gray-300 rounded-lg text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-green-600 focus:border-green-600 transition-colors duration-200" value="<?php echo e(explode(' ', $user->full_name ?? 'علی احمدی')[1] ?? 'احمدی'); ?>">
                            </div>
                            <div>
                                <label for="national_code" class="block text-sm font-medium text-gray-700 mb-1">کد ملی:</label>
                                <input type="text" id="national_code" name="national_code" class="w-full px-4 py-3 border border-gray-300 rounded-lg text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-green-600 focus:border-green-600 transition-colors duration-200" value="<?php echo e($user->national_code ?? '1234567890'); ?>">
                            </div>
                            <div>
                                <label for="birthDateInput" class="block text-sm font-medium text-gray-700 mb-1">تاریخ تولد:</label>
                                <div class="flex items-center justify-between">
                                    <input type="text" id="birthDateInput" name="birth_date_display" class="w-full px-4 py-3 border border-gray-300 rounded-lg text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-green-600 focus:border-green-600 transition-colors duration-200" value="<?php echo e($user->birth_date ?? '1368/05/15'); ?>" readonly>
                    ...
                    <div class="bg-gray-50 p-6 rounded-xl shadow-sm border border-gray-100">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <div class="flex items-center justify-between">
                                    <input type="text" id="mobile_number_display" name="mobile_number_display" class="w-full px-4 py-3 border border-gray-300 rounded-lg text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-green-600 focus:border-green-600 transition-colors duration-200" value="<?php echo e($user->mobile_number ?? '09123456789'); ?>" readonly>
                            ...
                            <div>
                                ...
                                <input type="email" id="email" name="email" class="w-full px-4 py-3 border border-gray-300 rounded-lg text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-green-600 focus:border-green-600 transition-colors duration-200" value="<?php echo e($user->email ?? 'ali.ahmadi@email.com'); ?>">
                            </div>
                            <div>
                                <label for="fixed_phone" class="block text-sm font-medium text-gray-700 mb-1">تلفن ثابت:</label>
                                <input type="text" id="fixed_phone" name="fixed_phone" class="w-full px-4 py-3 border border-gray-300 rounded-lg text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-green-600 focus:border-green-600 transition-colors duration-200" value="<?php echo e($user->fixed_phone ?? '021-12345678'); ?>">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div id="birthDateModal" class="custom-modal-overlay">
        <div class="custom-modal-content">
            ...
            <form id="birthDateForm" class="space-y-4" action="<?php echo e(route('profile.birth-date.update')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <?php echo method_field('PUT'); ?> 
    ...
    <div id="legalInfoModal" class="custom-modal-overlay">
        <div class="custom-modal-content">
            ...
            <form id="legalInfoForm" class="space-y-4" action="<?php echo e(route('profile.legal-info.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                 
                <div>
                    <label for="fullName" class="block text-sm font-medium text-gray-700 mb-2">نام و نام خانوادگی:</label>
                    <input type="text" id="fullName" name="full_name" class="w-full px-4 py-3 border border-gray-300 rounded-lg text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-green-600 focus:border-green-600 transition-colors duration-200" value="<?php echo e($user->full_name ?? ''); ?>" required>
                </div>
                <div>
                    <label for="nationalCode" class="block text-sm font-medium text-gray-700 mb-2">کد ملی:</label>
                    <input type="text" id="nationalCode" name="national_code" class="w-full px-4 py-3 border border-gray-300 rounded-lg text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-green-600 focus:border-green-600 transition-colors duration-200" value="<?php echo e($user->national_code ?? ''); ?>" required>
                </div>
                <div>
                    <label for="shebaNumber" class="block text-sm font-medium text-gray-700 mb-2">شماره شبا:</label>
                    <input type="text" id="shebaNumber" name="sheba_number" class="w-full px-4 py-3 border border-gray-300 rounded-lg text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-green-600 focus:border-green-600 transition-colors duration-200" value="<?php echo e($user->sheba_number ?? ''); ?>">
                </div>
                <div>
                    <label for="cardNumber" class="block text-sm font-medium text-gray-700 mb-2">شماره کارت:</label>
                    <input type="text" id="cardNumber" name="card_number" class="w-full px-4 py-3 border border-gray-300 rounded-lg text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-green-600 focus:border-green-600 transition-colors duration-200" value="<?php echo e($user->card_number ?? ''); ?>">
                </div>
                <div>
                    <label for="province" class="block text-sm font-medium text-gray-700 mb-2">استان:</label>
                    <input type="text" id="province" name="province" class="w-full px-4 py-3 border border-gray-300 rounded-lg text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-green-600 focus:border-green-600 transition-colors duration-200" value="<?php echo e($user->province ?? ''); ?>">
                </div>
                <div>
                    <label for="city" class="block text-sm font-medium text-gray-700 mb-2">شهر:</label>
                    <input type="text" id="city" name="city" class="w-full px-4 py-3 border border-gray-300 rounded-lg text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-green-600 focus:border-green-600 transition-colors duration-200" value="<?php echo e($user->city ?? ''); ?>">
                </div>
                <div>
                    <label for="postalCode" class="block text-sm font-medium text-gray-700 mb-2">کد پستی:</label>
                    <input type="text" id="postalCode" name="postal_code" class="w-full px-4 py-3 border border-gray-300 rounded-lg text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-green-600 focus:border-green-600 transition-colors duration-200" value="<?php echo e($user->postal_code ?? ''); ?>">
                </div>
                <div>
                    <label for="address" class="block text-sm font-medium text-gray-700 mb-2">آدرس کامل:</label>
                    <textarea id="address" name="address" class="w-full px-4 py-3 border border-gray-300 rounded-lg text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-green-600 focus:border-green-600 transition-colors duration-200" rows="3"><?php echo e($user->address ?? ''); ?></textarea>
                </div>
    ...
    <div id="mobileEditModal" class="custom-modal-overlay">
        <div class="custom-modal-content">
            ...
            <form id="mobileEditForm" class="space-y-4" action="<?php echo e(route('profile.mobile.update')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <?php echo method_field('PUT'); ?> 
                <div>
                    <label for="mobileNumber" class="block text-sm font-medium text-gray-700 mb-2">شماره موبایل جدید:</label>
                    <input type="text" id="mobileNumber" name="mobile_number" class="w-full px-4 py-3 border border-gray-300 rounded-lg text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-green-600 focus:border-green-600 transition-colors duration-200" value="<?php echo e($user->mobile_number ?? ''); ?>" required>
                </div>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const initialBirthDateFromDB = "<?php echo e($user->birth_date ?? ''); ?>";
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\myshop\resources\views\profile.blade.php ENDPATH**/ ?>