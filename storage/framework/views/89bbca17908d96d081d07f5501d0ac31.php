...
<div id="auth-modal-overlay" class="auth-modal-overlay hidden">
    <div class="auth-modal-content">
        ...
        <form id="mobile-login-step" class="auth-form">
            ...
            <div class="auth-switch-link hidden"> 
                هنوز حساب کاربری ندارید؟ <a href="<?php echo e(url('/register')); ?>" class="text-green-800 font-semibold hover:underline">ثبت نام</a>
            </div>
        </form>
...
<?php /**PATH C:\xampp\htdocs\myshop\resources\views/partials/auth-modal.blade.php ENDPATH**/ ?>