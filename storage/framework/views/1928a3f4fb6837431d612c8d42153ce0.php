...
<?php $__env->startSection('title', 'افزودن پست جدید - داشبورد ویرایشگر'); ?>
...
<div class="container mx-auto px-4 py-8">
    <div class="bg-white shadow-lg rounded-lg p-6 mb-8">
        ...
        <form action="<?php echo e(route('editor.posts.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.editor', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\myshop\resources\views\editor\posts\create.blade.php ENDPATH**/ ?>