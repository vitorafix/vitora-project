                ...
                <div class="md:w-1/2 bg-gray-50 p-6 rounded-lg shadow-inner">
                    ...
                    <div class="space-y-4" id="cart-items-summary"> 
                        <?php $__empty_1 = true; $__currentLoopData = $cartItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div class="flex justify-between items-center border-b pb-4 last:border-b-0 last:pb-0"
                                data-item-id="<?php echo e($item['cart_item_id']); ?>" 
                                data-item-price="<?php echo e($item['product_price']); ?>"
                                data-item-quantity="<?php echo e($item['quantity']); ?>">
                                <div class="flex items-center">
                                    
                                    
                                    <img src="<?php echo e($item['thumbnail_url_small'] ?? $item['image'] ?? 'https://placehold.co/60x60/E5E7EB/4B5563?text=Product'); ?>"
                                        onerror="this.onerror=null;this.src='https://placehold.co/60x60/E5E7EB/4B5563?text=Product';"
                                        alt="<?php echo e($item['product_name']); ?>" class="w-16 h-16 object-cover rounded-lg ml-3">
                                    <div>
                                        <h3 class="text-lg font-semibold text-gray-800"><?php echo e($item['product_name']); ?></h3>
                                ...
                                <span class="item-subtotal text-green-700 font-bold text-lg" data-subtotal="<?php echo e($item['product_price'] * $item['quantity']); ?>">
                                    <?php echo e(number_format($item['product_price'] * $item['quantity'])); ?> تومان
                                </span>
                            </div>
                    ...
                    <?php if(!$cartItems->isEmpty()): ?>
                        ...
                        <div class="border-t border-gray-200 pt-4 mt-6 flex justify-between items-center text-xl font-bold text-brown-900">
                            <span>جمع کل:</span>
                            <span id="cart-total-price" class="text-green-700" data-total-price="<?php echo e($cartTotalPrice); ?>">
                                <?php echo e(number_format($cartTotalPrice)); ?> تومان
                            </span>
                        </div>
                    <?php endif; ?>
                </div>
