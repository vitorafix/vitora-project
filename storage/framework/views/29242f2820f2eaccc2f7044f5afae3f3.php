...
<?php $__env->startSection('title', 'مدیریت دیدگاه‌ها - داشبورد ویرایشگر'); ?>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full bg-white rounded-lg overflow-hidden">
                ...
                <tbody class="text-gray-700">
                    ...
                    ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="border-b border-gray-200 hover:bg-gray-50">
                            <td class="py-3 px-4"><?php echo e($comment['author']); ?></td>
                            <td class="py-3 px-4"><?php echo e(Str::limit($comment['content'], 50)); ?></td>
                            <td class="py-3 px-4"><?php echo e($comment['post_title']); ?></td>
                            <td class="py-3 px-4">
                                <span class="px-3 py-1 rounded-full text-xs font-semibold <?php echo e($comment['status'] == 'تایید شده' ? 'bg-green-200 text-green-800' : 'bg-yellow-200 text-yellow-800'); ?>">
                                    <?php echo e($comment['status']); ?>

                                </span>
                            </td>
                            <td class="py-3 px-4 text-center">
                                <?php if($comment['status'] == 'در انتظار تایید'): ?>
                                    <button class="text-green-600 hover:text-green-800 mx-1 approve-comment-btn" title="تایید دیدگاه" data-comment-id="<?php echo e($comment['id']); ?>">
                                        <i class="fas fa-check-circle"></i>
                                    </button>
                                <?php endif; ?>
                                <button class="text-red-600 hover:text-red-800 mx-1 delete-comment-btn" title="حذف دیدگاه" data-comment-id="<?php echo e($comment['id']); ?>" data-comment-author="<?php echo e($comment['author']); ?>">
...
<?php echo $__env->make('layouts.editor', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\myshop\resources\views\editor\comments\index.blade.php ENDPATH**/ ?>