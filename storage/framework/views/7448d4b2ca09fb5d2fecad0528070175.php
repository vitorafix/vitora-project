        ...
        <div class="flex-1 p-6 lg:p-8">
            <div class="bg-white dark:bg-gray-800 shadow-xl rounded-lg border border-gray-200 dark:border-gray-700 p-6 sm:p-8">
                <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-4">
                    <?php echo e(__('خلاصه فعالیت‌ها')); ?>

                </h3>
                <p class="text-gray-700 dark:text-gray-300">
                    <?php echo e(__('به داشبورد خود خوش آمدید،')); ?> <?php echo e(Auth::user()->name); ?>!
                </p>
                <p class="mt-2 text-gray-600 dark:text-gray-400">
                    <?php echo e(__('در اینجا می‌توانید خلاصه فعالیت‌های خود، سفارش‌های اخیر و اعلان‌ها را مشاهده کنید.')); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\myshop\resources\views/dashboard.blade.php ENDPATH**/ ?>