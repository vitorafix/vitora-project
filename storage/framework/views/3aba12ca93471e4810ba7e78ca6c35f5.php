...
<section id="hero-carousel" class="relative overflow-hidden flex flex-col items-center justify-center text-center text-white p-8" style="height: calc(100vh - var(--nav-height, 0px));">
    ...
    <div class="hero-slide absolute inset-0 w-full h-full bg-cover bg-center transition-opacity duration-1000 ease-in-out opacity-100" style="background-image: url('<?php echo e(asset('uploads/hero-banner.jpg')); ?>');">
        ...
        <div class="relative z-10 w-full px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-center h-full">
            ...
            <a href="<?php echo e(route('products.index')); ?>" class="btn-primary-hero animate-fade-in-up delay-400">
    ...
    <div class="hero-slide absolute inset-0 w-full h-full bg-cover bg-center transition-opacity duration-1000 ease-in-out opacity-0" style="background-image: url('<?php echo e(asset('uploads/hero-banner-2.jpg')); ?>');">
        ...
        <div class="relative z-10 w-full px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-center h-full">
            ...
            <a href="<?php echo e(route('about')); ?>" class="btn-primary-hero animate-fade-in-up delay-400">
    ...
    <div class="hero-slide absolute inset-0 w-full h-full bg-cover bg-center transition-opacity duration-1000 ease-in-out opacity-0" style="background-image: url('<?php echo e(asset('uploads/hero-banner-3.jpg')); ?>');">
        ...
        <div class="relative z-10 w-full px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-center h-full">
            ...
            <a href="<?php echo e(route('contact')); ?>" class="btn-primary-hero animate-fade-in-up delay-400">
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp\htdocs\myshop\resources\views\partials\_hero-section.blade.php ENDPATH**/ ?>