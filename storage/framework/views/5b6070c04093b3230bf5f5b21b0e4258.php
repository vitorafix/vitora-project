...
<?php $__env->startSection('title', 'ایجاد محصول جدید - چای ابراهیم'); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-6">
                    ...
                    <textarea id="description" name="description" rows="6"
                              ...
                              placeholder="توضیحات کامل محصول را اینجا بنویسید."><?php echo e(old('description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="number" id="stock" name="stock" value="<?php echo e(old('stock')); ?>" min="0"
                               class="form-input w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-green-700 focus:border-green-700 transition-all duration-200"
                    ...
                    <div>
                        ...
                        <select id="category_id" name="category_id"
                            ...
                            <?php else: ?>
                                ...
                                <option value="1" <?php echo e(old('category_id') == 1 ? 'selected' : ''); ?>>چای سیاه</option>
                                <option value="2" <?php echo e(old('category_id') == 2 ? 'selected' : ''); ?>>چای سبز</option>
                                <option value="3" <?php echo e(old('category_id') == 3 ? 'selected' : ''); ?>>چای سفید</option>
                            <?php endif; ?>
                        </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <select id="status" name="status"
                                class="form-select w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-green-700 focus:border-green-700 transition-all duration-200"
                                required>
                            <option value="1" <?php echo e(old('status', 1) == 1 ? 'selected' : ''); ?>>فعال</option>
                            <option value="0" <?php echo e(old('status', 1) == 0 ? 'selected' : ''); ?>>غیرفعال</option>
                        </select>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\myshop\resources\views\product-create.blade.php ENDPATH**/ ?>