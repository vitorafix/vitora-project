    ...
    <div id="user-modal-overlay" class="custom-modal-overlay hidden">
        <div class="custom-modal-content">
            ...
            <form id="user-form" class="space-y-4">
                <?php echo csrf_field(); ?> 
                <input type="hidden" id="user-form-method" name="_method" value="POST"> 
...
<?php /**PATH C:\xampp\htdocs\myshop\resources\views\partials\_user_management.blade.php ENDPATH**/ ?>