    <?php
    // File: app/Services/Contracts/CartServiceInterface.php - مسیر صحیح: app/Contracts/Services/CartServiceInterface.php
    namespace App\Contracts\Services; // Namespace صحیح
