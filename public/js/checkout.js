...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function validateFormFields(data) {
        ...
        // NOTE: The 'new' address option was removed in checkout.blade.php, so this condition
        // will now primarily apply if document.querySelectorAll('input[name="selected_address_id"]').length === 0
        // (i.e., no addresses at all, requiring new address input).
    ...
    // This ensures elements exist before we try to get them
